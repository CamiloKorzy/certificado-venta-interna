...
cur = conn.cursor()
cur.execute("SELECT numerodocumento, importe, estadoautorizacion, cantidadworkflow, precio, fecha, producto, cantidadvinculada FROM ceesa_cee_certificados_ventas_internas WHERE numerodocumento = 'CI-0001-00000023'")
