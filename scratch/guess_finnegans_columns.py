...
def discover():
    candidates = [
        "itemcantidad", "itemprecio", "itemimporte", "conceptonombre", 
        "productonombre", "equiposolicitantenombre", "comprobante", "documento",
        "precio_unitario", "horas_trabajadas", "total_imputado"
    ]
