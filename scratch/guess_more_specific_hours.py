...
def discover():
    candidates = [
        "horas_certificadas", "hs_certificadas", "horas_imputar", "horas_a_imputar", 
        "hs_imputar", "hs_a_imputar", "horas_imputadas", "hs_imputadas", 
        "total_horas", "horas_totales", "horas_acumuladas", "horas_anterior", 
        "horas_presente", "cantidad_presente", "cantidad_anterior", "cantidad_acumulada", 
        "importe_presente", "importe_anterior", "importe_acumulado", "precio_unitario"
    ]
